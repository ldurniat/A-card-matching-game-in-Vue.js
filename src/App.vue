...
const cartItem = ['bat', 'candy', 'cauldron', 'cupcake', 'ghost', 'moon', 'pumpkin', 'witch-hat']
...
<template>
    ...
    <section class="description">
        ...
        <p> A card game matching game powered by Vue.js</p>
    </section>
    <TransitionGroup  tag="section" name="shuffle-card" class="game-board">
